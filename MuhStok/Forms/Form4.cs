...
namespace MuhStok.Forms
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (txtisturu.Text == "")
            {
                MessageBox.Show("Lütfen işlem türünü giriniz.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                komut.Parameters.AddWithValue("@islemturu", txtisturu.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            string komut = "select kimlik,islemturu FROM islemturleri ORDER by kimlik ASC";
            ...
            dataGridView1.Columns[1].HeaderText = "İşlem Adı";
